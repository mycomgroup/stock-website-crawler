...
└── strategy_autoresearch_rfscore7_pb10_enhanced_20260407/   # 实验子目录
...
python setup.py --strategy-file /Users/fengzhi/Downloads/git/testlixingren/strategies/Ricequant/rfscore7_pb10_enhanced.py
```

可选参数：
- `--name my_strategy` — 自定义策略名（默认取文件名）
- `--start-date 2025-04-07` — 回测开始日期
- `--end-date 2026-03-31` — 回测结束日期
- `--capital 100000` — 初始资金
- `--benchmark 000300.XSHG` — 基准指数

脚本自动完成：
1. 在 RiceQuant 创建/复用 `autoresearch_rfscore7_pb10_enhanced_20260407` 策略，获取 strategy_id
...
```bash
cat strategy_autoresearch_rfscore7_pb10_enhanced_20260407/history/iterations.tsv
```
