...
id: "url-bd3be47"
type: "api"
title: "Google Broaden Searches API"
url: "https://serpapi.com/broaden-searches"
description: "Google searches that may be related to other search terms are presented within the Broaden Searches section, typically near the bottom of the search page. These results usually only appear on mobile and tablet devices. They are parsed and exist within the broaden_searches array in the JSON output. Broaden searches can contain thumbnails, title, and link.\n\nThe API endpoint is https://serpapi.com/search?engine=google Head to the playground for a live and interactive demo."
source: ""
tags: []
crawl_time: "2026-03-18T10:18:19.869Z"
metadata:
  ...
  responseStructure: []
  examples:
    - {"title":"Results for: charli d'amelio videos","description":"","requestParams":{"q":"charli d'amelio videos","hl":"en","gl":"us","device":"mobile","highlight":"broaden_searches"},"responseJson":"https://serpapi.com/search.json?q=charli+d'amelio+videos&hl=en&gl=us&device=mobile"}
  ...
  suggestedFilename: "broaden-searches-api"
---
...
https://serpapi.com/broaden-searches
