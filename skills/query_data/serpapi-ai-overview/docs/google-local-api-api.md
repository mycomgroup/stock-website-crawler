...
description: "Our Google Local API allows you to scrape results from the Google Local page.\n\nThe API endpoint is https://serpapi.com/search?engine=google_local Head to the playground for a live and interactive demo."
source: ""
tags: []
crawl_time: "2026-03-18T11:06:30.076Z"
metadata:
  ...
  responseStructure: []
  examples:
    - {"title":"Results for: Coffee","description":"","requestParams":{"engine":"google_local","q":"Coffee","location":"New York, New York, United States","highlight":"local_results"},"responseJson":"https://serpapi.com/search.json?engine=google_local&q=Coffee&location=New+York,+New+York,+United+States"}
  ...
  suggestedFilename: "google-local-api-api"
---
...
Our Google Local API allows you to scrape results from the Google Local page.
