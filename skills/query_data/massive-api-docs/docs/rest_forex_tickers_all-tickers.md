...
https://massive.com/docs/rest/forex/tickers/all-tickers
...
```bash
curl -X GET "https://api.massive.com/v3/reference/tickers?market=fx&active=true&order=asc&limit=100&sort=ticker&apiKey=YOUR_API_KEY"
```
