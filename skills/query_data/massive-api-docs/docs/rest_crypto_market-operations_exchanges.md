...
https://massive.com/docs/rest/crypto/market-operations/exchanges
...
```bash
curl -X GET "https://api.massive.com/v3/reference/exchanges?asset_class=crypto&locale=global&apiKey=YOUR_API_KEY"
```
