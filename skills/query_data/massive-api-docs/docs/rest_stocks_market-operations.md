...
https://massive.com/docs/rest/stocks/market-operations
...
```bash
curl -X GET "https://api.massive.com/v3/reference/exchanges?asset_class=stocks&locale=us&apiKey=YOUR_API_KEY"
```
