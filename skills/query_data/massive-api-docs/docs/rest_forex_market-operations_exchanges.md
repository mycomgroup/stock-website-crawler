...
https://massive.com/docs/rest/forex/market-operations/exchanges
...
```bash
curl -X GET "https://api.massive.com/v3/reference/exchanges?asset_class=fx&locale=global&apiKey=YOUR_API_KEY"
```
