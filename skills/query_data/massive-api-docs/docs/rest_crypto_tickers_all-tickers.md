...
https://massive.com/docs/rest/crypto/tickers/all-tickers
...
```bash
curl -X GET "https://api.massive.com/v3/reference/tickers?market=crypto&active=true&order=asc&limit=100&sort=ticker&apiKey=YOUR_API_KEY"
```
