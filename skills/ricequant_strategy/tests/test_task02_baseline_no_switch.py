"""
Tests for task02_baseline_no_switch.py
"""
import sys
...
class TestInit:
    def test_init_sets_parameters(self, mock_context_baseline, inject_mocks, mock_scheduler):
        module = importlib.import_module("task02_baseline_no_switch")
...
class TestGetZtCount:
    def test_get_zt_count_returns_int(self, mock_context_baseline, inject_mocks):
        module = importlib.import_module("task02_baseline_no_switch")
        result = module.get_zt_count(mock_context_baseline)
        
        assert isinstance(result, int)

    def test_get_zt_count_positive(self, mock_context_baseline, inject_mocks):
        module = importlib.import_module("task02_baseline_no_switch")
        result = module.get_zt_count(mock_context_baseline)
        
        assert result >= 0

    def test_get_zt_count_filters_special_stocks(self, mock_context_baseline, inject_mocks):
    ...
    def test_get_zt_count_exception_returns_default(self, mock_context_baseline, inject_mocks):
    ...
    def test_get_zt_count_empty_stocks(self, mock_context_baseline, inject_mocks):
    ...
    def test_get_zt_count_none_bars(self, mock_context_baseline, inject_mocks):
    ...
    def test_get_zt_count_limit_up_detection(self, mock_context_baseline, inject_mocks):
...
class TestSelectStocks:
    def test_select_stocks_returns_list(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 5
        module = importlib.import_module("task02_baseline_no_switch")
        result = module.select_stocks(mock_context_baseline)
        
        assert isinstance(result, list)

    def test_select_stocks_empty_result(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 5
    ...
    def test_select_stocks_max_positions_limit(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 2
        module = importlib.import_module("task02_baseline_no_switch")
        result = module.select_stocks(mock_context_baseline)
        
        assert len(result) <= 2

    def test_select_stocks_filters_special_stocks(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 5
    ...
    def test_select_stocks_exception_returns_empty(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 5
    ...
    def test_select_stocks_none_bars(self, mock_context_baseline, inject_mocks):
        mock_context_baseline.max_positions = 5
...
class TestAdjustPositions:
    def test_adjust_positions_sells_not_selected(self, mock_context_baseline, inject_mocks):
        mock_order_target = MagicMock()
        mock_order_target_percent = MagicMock()
        
        mock_context_baseline.position_size = 0.2
        mock_context_baseline.portfolio.positions = {"000001.XSHE": MagicMock()}
        ...
        module.adjust_positions(mock_context_baseline, selected)
        
        mock_order_target.assert_called()

    def test_adjust_positions_buys_selected(self, mock_context_baseline, inject_mocks):
        mock_order_target = MagicMock()
        mock_order_target_percent = MagicMock()
        
        mock_context_baseline.position_size = 0.2
        mock_context_baseline.portfolio.positions = {}
    ...
    def test_adjust_positions_holds_existing(self, mock_context_baseline, inject_mocks):
        mock_order_target = MagicMock()
        mock_order_target_percent = MagicMock()
...
class TestRebalance:
    def test_rebalance_with_selected_stocks(self, mock_context_baseline, inject_mocks, capsys):
        mock_context_baseline.max_positions = 5
        mock_context_baseline.position_size = 0.2
        mock_context_baseline.portfolio.positions = {}
        ...
        module.rebalance(mock_context_baseline, bar_dict)
    ...
    def test_rebalance_no_selected_stocks(self, mock_context_baseline, inject_mocks, capsys):
        mock_context_baseline.max_positions = 5
        mock_context_baseline.position_size = 0.2
        mock_context_baseline.portfolio.positions = {}
    ...
    def test_rebalance_prints_zt_count(self, mock_context_baseline, inject_mocks, capsys):
        mock_context_baseline.max_positions = 5
        mock_context_baseline.position_size = 0.2
        mock_context_baseline.portfolio.positions = {}
        ...
        captured = capsys.readouterr()
        assert "无开关直接开仓" in captured.out