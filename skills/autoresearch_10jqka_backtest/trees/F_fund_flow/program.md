...
python ${SKILL_DIR}/run_iteration.py \
  ...
  --mutation-summary "F_fund_flow 单轮验证"
```
...
```bash
cat skills/autoresearch_10jqka_backtest/trees/F_fund_flow/experiments/<name>/state.json
cat skills/autoresearch_10jqka_backtest/trees/F_fund_flow/experiments/<name>/iterations.tsv | tail -5
```
