...
```bash
cat skills/autoresearch_10jqka_backtest/trees/A_value/experiments/<name>/state.json
cat skills/autoresearch_10jqka_backtest/trees/A_value/experiments/<name>/iterations.tsv | tail -5
```
