...
python ${SKILL_DIR}/run_iteration.py \
  ...
  --mutation-summary "H_composite 单轮验证"
```
...
```bash
cat skills/autoresearch_10jqka_backtest/trees/H_composite/experiments/<name>/state.json
cat skills/autoresearch_10jqka_backtest/trees/H_composite/experiments/<name>/iterations.tsv | tail -5
```
