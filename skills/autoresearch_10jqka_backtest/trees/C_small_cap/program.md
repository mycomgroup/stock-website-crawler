...
python ${SKILL_DIR}/run_iteration.py \
  ...
  --mutation-summary "C_small_cap 单轮验证"
```
...
```bash
cat skills/autoresearch_10jqka_backtest/trees/C_small_cap/experiments/<name>/state.json
cat skills/autoresearch_10jqka_backtest/trees/C_small_cap/experiments/<name>/iterations.tsv | tail -5
```
