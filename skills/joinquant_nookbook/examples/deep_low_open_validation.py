...
for year in years:
    ...
    test_dates = [d for d in all_dates if d.startswith(str(year))]
...
if len(all_signals) == 0:
    ...
    if len(deep_low_all) > 0:
        ...
        print("\n深度低开各年份样本数：")
        for year in years:
            year_deep = deep_low_all[deep_low_all["date"].str.startswith(str(year))]
    ...
    df_2024 = df_all[df_all["date"].str.startswith("2024")]
    ...
    output_file = "/Users/fengzhi/Downloads/git/testlixingren/skills/joinquant_nookbook/output/deep_low_open_validation.json"
