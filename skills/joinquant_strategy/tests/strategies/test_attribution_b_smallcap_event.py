...
class TestAttributionBSmallcapEvent:
    def test_initialize(self, mock_jqdata, mock_g):
        with patch('jqdata.g', mock_g):
            import attribution_b_smallcap_event
            mock_context = SimpleNamespace()
            attribution_b_smallcap_event.initialize(mock_context)
    ...
    def test_select_stocks_normal(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_valuation_df, mock_price_df_limit_up):
        with patch('jqdata.g', mock_g):
            ...
            attribution_b_smallcap_event.select_stocks(mock_context)
    ...
    def test_select_stocks_filters_cap_range(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_price_df_limit_up):
        with patch('jqdata.g', mock_g):
            import attribution_b_smallcap_event
            ...
            valuation_outside_range = pd.DataFrame({
                'code': ['000001.XSHE'],
                'circulating_market_cap': [50.0]
            })
            mock_jqdata.get_fundamentals.return_value = valuation_outside_range
            mock_jqdata.get_price.return_value = mock_price_df_limit_up
    ...
    def test_buy_stocks_no_target(self, mock_jqdata, mock_g, mock_context):
        with patch('jqdata.g', mock_g):
            ...
            attribution_b_smallcap_event.buy_stocks(mock_context)
    ...
    def test_buy_stocks_in_range(self, mock_jqdata, mock_g, mock_context):
        with patch('jqdata.g', mock_g):
            import attribution_b_smallcap_event
    ...
    def test_sell_stocks_with_profit(self, mock_jqdata, mock_g, mock_context):
        with patch('jqdata.g', mock_g):
            ...
            attribution_b_smallcap_event.sell_stocks(mock_context)
    ...
    def test_buy_stocks_multiple_targets(self, mock_jqdata, mock_g, mock_context):
        with patch('jqdata.g', mock_g):
            import attribution_b_smallcap_event
            ...
            stock_data1.day_open = 9.85
            stock_data1.pre_close = 10.0
            stock_data1.last_price = 10.0
            
            stock_data2 = SimpleNamespace()
            stock_data2.paused = True
    ...
    def test_select_stocks_no_limit_up(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_valuation_df):
        with patch('jqdata.g', mock_g):
            import attribution_b_smallcap_event
