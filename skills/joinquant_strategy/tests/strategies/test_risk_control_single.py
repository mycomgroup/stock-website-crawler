...
class TestRiskControlSingle:
    ...
    def setup_mocks(self, mock_jqdata):
        ...
        import risk_control_single as module
        self.module = module
    ...
    def test_initialize_sets_options(self):
        ...
        assert self.jqdata.run_daily.call_count == 6
    ...
    def test_initialize_sets_global_variables(self):
        ...
        assert self.g.stop_loss_count == 0
    ...
    def test_sell_1030_no_closeable_amount(self):
        context = SimpleNamespace()
        context.portfolio = SimpleNamespace()
    ...
    def test_sell_1330_at_limit_keeps_position(self):
        context = SimpleNamespace()
        context.portfolio = SimpleNamespace()
