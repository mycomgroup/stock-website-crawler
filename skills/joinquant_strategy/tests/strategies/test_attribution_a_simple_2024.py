...
class TestAttributionASimple2024:
    def test_initialize(self, mock_jqdata, mock_g):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
            mock_context = SimpleNamespace()
            attribution_a_simple_2024.initialize(mock_context)
    ...
    def test_rebalance_normal_flow(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_fundamentals_df):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
            ...
            attribution_a_simple_2024.rebalance(mock_context)
            
            mock_jqdata.order_target_value.assert_called()

    def test_rebalance_empty_fundamentals(self, mock_jqdata, mock_g, mock_context, mock_securities):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
    ...
    def test_rebalance_sells_non_target_positions(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_fundamentals_df):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
    ...
    def test_rebalance_filters_st(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_fundamentals_df):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
            ...
            st_df = create_st_df(['000001.XSHE', '000002.XSHE', '600000.XSHG'], [False, True, False])
            mock_jqdata.get_extras.return_value = st_df
            mock_jqdata.get_fundamentals.return_value = mock_fundamentals_df
            
            attribution_a_simple_2024.rebalance(mock_context)
            
            mock_jqdata.get_extras.assert_called()
    ...
    def test_rebalance_filters_new_stocks(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_fundamentals_df):
        with patch('jqdata.g', mock_g):
            ...
            mock_jqdata.get_security_info.return_value = mock_security_info_new
    ...
    def test_rebalance_no_stocks_after_filtering(self, mock_jqdata, mock_g, mock_context, mock_securities):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
            ...
            mock_security_info_new = SimpleNamespace()
            mock_security_info_new.start_date = datetime(2024, 1, 10)
            mock_jqdata.get_security_info.return_value = mock_security_info_new
            
            st_df = create_st_df(['000001.XSHE', '000002.XSHE', '600000.XSHG'], [True, True, True])
            mock_jqdata.get_extras.return_value = st_df
            
            attribution_a_simple_2024.rebalance(mock_context)
            
            mock_jqdata.get_fundamentals.assert_not_called()

    def test_rebalance_keeps_existing_positions(self, mock_jqdata, mock_g, mock_context, mock_securities, mock_fundamentals_df):
        with patch('jqdata.g', mock_g):
            import attribution_a_simple_2024
