...
class TestFactorTestDoubleFactor:
    @pytest.fixture
    ...
    def test_initialize(self, setup_mocks):
        import factor_test_double_factor as module
    ...
    def test_get_stock_list_filters_by_turnover(self, setup_mocks):
        ...
        def mock_hsl(stocks, date):
            if '000001.XSHE' in stocks:
                return [{'000001.XSHE': 15.0}]
            return [{'000002.XSHE': 35.0}]
        
        setup_mocks['jqlib'].HSL.side_effect = mock_hsl
        
        module.get_stock_list(setup_mocks['context'])
        
        setup_mocks['jqlib'].HSL.assert_called()

    def test_get_stock_list_handles_exception_in_hsl(self, setup_mocks):
        import factor_test_double_factor as module
        module.g = setup_mocks['g']
        module.g.max_cap = 50
        module.g.max_turnover = 30
    ...
    def test_filters_high_turnover(self, setup_mocks):
        import factor_test_double_factor as module
        module.g = setup_mocks['g']
        module.g.max_cap = 50
