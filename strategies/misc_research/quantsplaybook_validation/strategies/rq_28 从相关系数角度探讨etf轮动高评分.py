# Auto-generated alias for placeholder rq_28 从相关系数角度探讨etf轮动高评分.txt
# Reuses migrated RiceQuant implementation from rq_28_ETF动量轮动评分.py
# Shared original URL: https://www.joinquant.com/post/34475
