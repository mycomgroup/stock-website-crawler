# Auto-generated alias for placeholder rq_18 动量ETF轮动-RSRS择时-卡尔曼滤波.txt
# Reuses migrated RiceQuant implementation from rq_48_动量ETF轮动RSRS卡尔曼滤波.py
# Shared original URL: https://www.joinquant.com/post/35416
