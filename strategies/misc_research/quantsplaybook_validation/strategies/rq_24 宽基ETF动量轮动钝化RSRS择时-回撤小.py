# Auto-generated alias for placeholder rq_24 宽基ETF动量轮动钝化RSRS择时-回撤小.txt
# Reuses migrated RiceQuant implementation from rq_24_宽基ETF钝化RSRS轮动.py
# Shared original URL: https://www.joinquant.com/post/37120
