...
# 大师策略——柯林·麦克连成长价值优势投资法 - RiceQuant版本
# 原文：大师策略——柯林·麦克连成长价值优势投资法
# 逻辑：选高ROE、低PB、净利润持续增长的成长价值股，月度调仓
...
def do_trade(context, bar_dict):
    ...
    try:
        ...
        factor_df = get_factor(
            stocks,
            ['pe_ratio', 'pb_ratio', 'market_cap', 'roe', 'gross_profit_margin', 'inc_net_profit_year_on_year'],
        )
