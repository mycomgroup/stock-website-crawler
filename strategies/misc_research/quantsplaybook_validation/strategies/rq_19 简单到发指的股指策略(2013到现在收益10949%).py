# Auto-generated alias for placeholder rq_19 简单到发指的股指策略(2013到现在收益10949%).txt
# Reuses migrated RiceQuant implementation from rq_23_简单股指期货尾盘.py
# Shared original URL: https://www.joinquant.com/post/30480
