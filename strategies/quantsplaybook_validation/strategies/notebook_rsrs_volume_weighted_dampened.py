# 成交额加权回归钝化 RSRS 择时策略 - RiceQuant Notebook 验证脚本
# 候选3: 成交额加权回归 + 钝化 RSRS (V11)
# 构造: 成交额加权回归计算 beta + 钝化公式
...
if prices is None or len(prices) < M:
    ...
    for i in range(N, len(prices)):
        ...
        # 成交额 = volume * close（近似）
        close_segment = closes[i - N : i]
        turnover = vol * close_segment
