...
try:
    from .industry_sw import (
        ...
        get_sw_level2,
        get_sw_level3,
        run_query_simple as run_query_simple_industry,
        query_industry_sw,
...
try:
    from .conversion_bond import (
        ...
        run_query_simple as run_query_simple_bond,
...
try:
    from .option import (
        ...
        query_option,
        get_option_quote,
        run_query_simple as run_query_simple_option,
    )
except ImportError:
    pass
