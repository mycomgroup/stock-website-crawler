...
try:
    from jk2bt.analysis.factors.technical import _get_daily_ohlcv, _compute_ema, safe_divide
except ImportError:
    from jk2bt.analysis.factors.technical import _get_daily_ohlcv, _compute_ema
