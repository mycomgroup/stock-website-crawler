...
class TestImportModes:
    ...
    def test_compatible_import_from_factors(self):
        """测试兼容导入模式：from jk2bt.analysis.factors import ..."""
    ...
    def test_compatible_import_base_module(self):
        """测试兼容导入：from jk2bt.analysis.factors import normalize_factor_name..."""
        from jk2bt.analysis.factors import normalize_factor_name, global_factor_registry
    ...
    def test_compatible_import_preprocess(self):
        """测试兼容导入：from jk2bt.analysis.factors import preprocess函数..."""
        from jk2bt.analysis.factors import winsorize_med, standardlize, neutralize
    ...
    def test_compatible_import_fundamentals(self):
        ...
        from jk2bt.analysis.factors import fundamentals
    ...
    def test_package_import_factors_submodule(self):
        """测试包内导入：from jk2bt.analysis.factors import ..."""
        from jk2bt.analysis.factors import get_factor_values_jq
    ...
    def test_both_import_modes_consistent(self):
        """测试两种导入模式返回同一对象。"""
        from jk2bt.analysis.factors import get_factor_values_jq as func1
...
class TestFactorPreprocessWinsorize:
    ...
    def test_winsorize_series_basic(self):
        """测试Series去极值基本功能。"""
        from jk2bt.analysis.factors import winsorize_med
...
class TestFactorPreprocessStandardlize:
    ...
    def test_standardlize_series_basic(self):
        """测试Series标准化基本功能。"""
        from jk2bt.analysis.factors import standardlize
...
class TestFactorPreprocessNeutralize:
    ...
    def test_neutralize_function_exists(self):
        """测试neutralize函数可导入。"""
        from jk2bt.analysis.factors import neutralize
...
class TestIntegrationScenarios:
    ...
    def test_factor_workflow_with_preprocess(self):
        """测试因子获取+预处理完整流程。"""
        from jk2bt.analysis.factors import get_factor_values_jq, winsorize_med, standardlize
...
class TestFactorModuleStructure:
    ...
    def test_factors_init_exports_normalize_functions(self):
        ...
        from jk2bt.analysis.factors import normalize_factor_name, normalize_factor_names
    ...
    def test_factors_init_exports_registry(self):
        ...
        from jk2bt.analysis.factors import global_factor_registry, FactorRegistry
    ...
    def test_factors_submodule_structure(self):
        """测试因子子模块结构完整。"""
        from jk2bt.analysis.factors import valuation, technical, fundamentals, growth, quality
