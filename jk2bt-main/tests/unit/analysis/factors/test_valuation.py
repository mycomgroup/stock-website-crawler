...
spec_base = importlib.util.spec_from_file_location(
    "jk2bt.analysis.factors.base", str(base_file_path)
)
...
try:
    spec_date = importlib.util.spec_from_file_location(
        "jk2bt.utils.date_utils", str(date_utils_path)
    )
...
try:
    spec_technical = importlib.util.spec_from_file_location(
        "jk2bt.analysis.factors.technical", str(technical_file_path)
    )
...
spec_valuation = importlib.util.spec_from_file_location(
    "jk2bt.analysis.factors.valuation", str(valuation_file_path)
)
...
_estimate_circulating_market_cap_from_daily = (
    valuation_module._estimate_circulating_market_cap_from_daily
)
