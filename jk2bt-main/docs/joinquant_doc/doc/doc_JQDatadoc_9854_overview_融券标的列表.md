...
type: "website"
title: "融券标的列表"
url: "https://www.joinquant.com/help/api/doc?name=JQDatadoc&id=9854"
description: "描述"
source: ""
tags: []
crawl_time: "2026-03-27T07:17:14.033Z"
metadata:
  parser: "JoinquantHelpParser"
  actualUrl: "https://www.joinquant.com/help/api/doc?name=JQDatadoc&id=9854"
  headings:
    - {"level":3,"text":"融券标的列表","id":""}
  ...
  codeBlocks:
    ...
    - {"language":"python","code":"# 判断平安银行是否在可融券列表\n'000001.XSHE' in get_marginsec_stocks(date='2018-07-05')\n>>> True"}
  blockquotes: []
  mainContent:
    - {"type":"heading","level":3,"content":"融券标的列表"}
    ...
    - {"type":"list","listType":"ul","items":["获取指定日期的融券标的列表"]}
    ...
    - {"type":"list","listType":"ul","items":["获取某一天的融券标的列表"]}
    - {"type":"codeblock","language":"python","content":"# 获取融券标的列表，并赋值给 marginsec_stocks\nmarginsec_stocks= get_marginsec_stocks(date='2018-07-05')\nprint(marginsec_stocks[:5])\n['000001.XSHE', '000002.XSHE', '000006.XSHE', '000009.XSHE', '000012.XSHE']"}
    - {"type":"list","listType":"ul","items":["判断某只股票是否在融券列表内"]}
    - {"type":"codeblock","language":"python","content":"# 判断平安银行是否在可融券列表\n'000001.XSHE' in get_marginsec_stocks(date='2018-07-05')\n>>> True"}
  suggestedFilename: "doc_JQDatadoc_9854_overview_融券标的列表"
  pageKind: "doc"
  pageName: "JQDatadoc"
  pageId: "9854"
  sectionHash: ""
...
https://www.joinquant.com/help/api/doc?name=JQDatadoc&id=9854
