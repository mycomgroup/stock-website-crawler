...
如果当前目标已经从“调研”进入“上线收敛”，优先看最终文档包：

- `/Users/fengzhi/Downloads/git/testlixingren/docs/final_rfscore_release_v1_20260329/00_index.md`
- `/Users/fengzhi/Downloads/git/testlixingren/docs/final_rfscore_release_v1_20260329/06_final_master_release_v1.md`
...
- 深化研究（v2.0）：
  - 结果文件：`result_06_research_event_driven_and_monitor_v2.md`
  - **调仓机制研究**: 推荐混合调仓（月度基础+季报增补+风控紧急）
    - RFScore因子本质是季度频率，月度调仓已足够
    - 季报发布后T+1或T+2是最佳调仓窗口
    - 最佳时机：周二至周四上午10:00-10:30
  - **监控指标体系v2.0**: 六大维度深化
    - 新增：估值偏度、ROA-OCF相关性、应计质量、综合信号强度
    - 新增：HHI指数、周期暴露、历史对比偏离度
    - 三级预警：🔴严重/🟡中度/🟢轻度，共18条规则
...
6. **质量监控体系v2.0**:
   - **评分模型**: 六维度0-100分，A+/A/B+/B/C+/C/D七级
   - **新增指标**: 偏度、相关性、应计、信号强度、HHI、周期暴露、历史偏离
   - **预警规则**: 三级18条，🔴严重/🟡中度/🟢轻度分级响应
7. **调仓机制优化**: 推荐混合调仓（月度+季报+风控），年预算15-17次
   - 最佳时机：周二至周四上午10:00-10:30
   - 季报窗口：4/8/10月底发布后T+1或T+2
